...
from my_utils.plot_utils import plot_CDAM
...
def cdam_pipeline(DATASET,
    ...
    attention_map, CDAM_maps, model_output = get_maps(model, img, grad, activation, class2idx=DATASET.info['label'], patch_size=PATCH_SIZE, clip=True)
...
def call_CDAM(DATASET, IDX:int, MODEL_BCKB:str, CKPT_VERSION:int):
